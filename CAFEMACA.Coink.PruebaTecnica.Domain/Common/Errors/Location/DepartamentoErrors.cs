...
namespace CAFEMACA.Coink.PruebaTecnica.Domain.Common.Errors.Location
{
    public class DepartamentoErrors
    {
        ...
        public static readonly DomainError RequiredIdPais = new("Departamento.RequiredIdPais", "Required Id Pais");
        public static readonly DomainError ValidIdPais = new("Departamento.ValidIdPais", "Id Pais length should 2");
        #endregion
